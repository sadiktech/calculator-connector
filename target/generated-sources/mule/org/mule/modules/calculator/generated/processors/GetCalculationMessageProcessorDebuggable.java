...
public class GetCalculationMessageProcessorDebuggable
    extends GetCalculationMessageProcessor
    implements DebugInfoProvider
{


    public GetCalculationMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("value2", "Value2", (int.class), value2, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("value1", "Value1", (int.class), value1, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("action", "Action", (java.lang.String.class), action, muleEvent));
